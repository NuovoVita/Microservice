...
class DevConfig(ProdConfig):
    ...
    CELERY_BROKER_URL = 'redis://192.168.1.70:6379/10'
    result_backend = 'redis://192.168.1.70:6379/10'
    cache_backend = 'redis://192.168.1.70:6379/10'
...
class TestConfig(ProdConfig):
    ...
    result_backend = 'redis://:Mjolnir@127.0.0.1:6379/0'
    cache_backend = 'redis://:Mjolnir@127.0.0.1:6379/0'
